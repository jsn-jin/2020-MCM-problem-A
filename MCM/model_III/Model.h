...
public:
    ...
    // modelA constructor
    Model(double c0, vector<double> herring, vector <double> mackerel, 
    		double input_k): h(herring),m(mackerel) {
        c_0 = c0;
        k = input_k;
    ...
    // modelB contructor
    Model(double c0,double input_a,vector<double> herring, vector <double> mackerel, 
    		vector<double> h0, vector<double>m0, double input_k,double input_X): 
    			h(herring),m(mackerel),h_0(h0),m_0(m0){
        c_0 = c0;
        a = input_a;
        k = input_k;
        X = input_X; // relocation year
    }
...
private:
    ...
    double k = 0;  			// number of times fish per year
